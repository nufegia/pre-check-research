...
TOOL_REGISTRY: dict[str, ToolSpec] = {
    ...
    "reference_audit": ToolSpec(
        ...
        description="Parse DOI/PMID and, when explicitly enabled, query Crossref, OpenAlex, PubPeer, and NCBI metadata, retraction, and post-publication discussion signals.",
