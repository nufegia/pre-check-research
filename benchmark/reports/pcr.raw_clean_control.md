...
|---|---|---:|---:|---|---|---|
| raw_clean_control | table | 80 | 5 | raw_observation_table | routed | /Users/daotuanwang/归档/项目/PreCheckResearch/mvp2/benchmark/inputs/raw_clean_control.csv |

## 材料覆盖矩阵

| 材料/模块 | 行数 | 列数 |
|---|---:|---:|
| raw_clean_control | 80 | 5 |
